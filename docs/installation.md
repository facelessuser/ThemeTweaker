...
!!! warning "Warning"
    This is not the recommended way to install ThemeTweaker for the casual user as it requires the user to know which branch to install, know how to use git, and **will not** get automatically updated.
