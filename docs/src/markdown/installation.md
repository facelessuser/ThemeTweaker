...
The recommended way to install ThemeTweaker is via [Package Control][package-control].  Package Control will install the
...
!!! warning "Warning"
    This is not the recommended way to install ThemeTweaker for the average user.  Installing this way **will not** get
    automatically updated.

    If you are forking for a pull request, you should **just** clone ThemeTweaker and run Package Control's
