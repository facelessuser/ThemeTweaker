...
Before submitting an issue search past issues and read the area of the [documentation](http://facelessuser.github.io/ThemeTweaker/) related to your specific question, issue, or request.
...
> Run the following command from the menu: `Preferences->Package Settings->ThemeTweaker->Support Info`.  Post the result here.
